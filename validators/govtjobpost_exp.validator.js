...
class GovtJobPostValidation {

   create(req, res, next) {
      const govtjobpost_schema = Joi.object({
      ...
      return BaseValidation.GovtJobPostBody(req, res, next, govtjobpost_schema)
   }
...
module.exports = new GovtJobPostValidation();
