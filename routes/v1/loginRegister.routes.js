...
const { seeker_validate , employer_validate } = require("../../validators");

// Register and Login Routes

loginRegisterRoutes.post('/seeker-register',    seeker_validate.seekerRegister,       loginRegisterController.seeker_register);
