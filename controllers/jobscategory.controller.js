...
JobCategoryController.create = async (req, res) => {
   ...
   try {
      ...
      let obj = {
         ...
         jcat_code: req.body.jcat_code,
         jcat_icon: req.body.jcat_icon,
         jcat_desc: req.body.jcat_desc,
         jcat_image: req.body.jcat_image,
         jcat_pos: req.body.jcat_pos,
         jcat_status: req.body.jcat_status,
         foot_status: req.body.foot_status,
         jcat_dt: new Date(req.body.jcat_dt)
      }
...
JobCategoryController.get = async (req, res) => {

   try {
      let { jcat_id } = req.query
      if (!jcat_id) throw createError.BadRequest()

      const { rows, count } = await jobscategoryService.findAllAndCount(jcat_id)
...
JobCategoryController.getByPk = async (req, res) => {
...
JobCategoryController.getCollegeDetails = async (req, res) => {
...
JobCategoryController.update = async (req, res) => {
...
JobCategoryController.delete = async (req, res) => {
