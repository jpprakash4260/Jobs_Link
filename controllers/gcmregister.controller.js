...
const { gcmregisterService } = require('../services')
...
class GcmRegisterController { }

GcmRegisterController.create = async (req, res) => {
   ...
   try {
      ...
      let obj = {
         ...
         gcm_status: req.body.gcm_status,
         gcm_dt: new Date(req.body.gcm_dt)
      }
...
GcmRegisterController.get = async (req, res) => {

   try {
      let { id } = req.query
      if (!id) throw createError.BadRequest()

      const { rows, count } = await gcmregisterService.findAllAndCount(id)
...
GcmRegisterController.getByPk = async (req, res) => {
...
GcmRegisterController.getCollegeDetails = async (req, res) => {
...
GcmRegisterController.update = async (req, res) => {
...
GcmRegisterController.delete = async (req, res) => {
   ...
   try {
      ...
      const deleted = await gcmregisterService.delete(id)
...
module.exports = GcmRegisterController
